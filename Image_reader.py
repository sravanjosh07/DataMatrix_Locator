...
# image = cv2.imread("Img_Data/DetectTask 039911 BOTTOM 0.jpg")
# print(type(image))
...
for image_path in os.listdir( path):
    ...
    kernel = cv2.getStructuringElement(cv2.MORPH_RECT, (45, 30))
    ...
    for cnt in cnts:
        ...
        if area > 0: #=32000 and area <= 42250 and shape[0] == 4:
